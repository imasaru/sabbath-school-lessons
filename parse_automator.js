...
fs.readdir(directory, (err, files) => {
  ...
  // Declares that folder 01 has been parsed before parsing (if omitted, 01 is never declared as parsed)
  console.log(files.length - 2 + " folders found.\n")
  console.log(folderNum + ' has been parsed.');
  ...
  for (; folderNum <= files.length - 2;) {
    ...
    for (var i = 0; i < 7; i++) {
      ...
      execSync('node bible_verse_parser_2.js ' + '-p ' + directory + folderNum +
        '\\' + ' -l ' + argv.l);
